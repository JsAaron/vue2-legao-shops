<template>
  <div class="legao-dialog">
    <!-- 订单详情 -->
    <common-dialog class="details-dialog" @close-self="handleClose" :visible="detailsVisible" title="订单详情">
      <div slot="main">
    ...
    <!-- 清点信息录入 -->
    <el-dialog class="details-dialog" title="清点信息录入"  :visible.sync="dialogTypeInVisible" :before-close="typeInClose" >
      <dl class="details-group">
        <dt>租借信息</dt>
        <dd>
      ...
      <dl class="details-group">
        ...
        <div class="bt">
          <el-button class="save-remark" type="primary" @click="detailsVisible = false">确定</el-button> 
          <el-button class="save-remark" type="primary" @click="detailsVisible = false">重置</el-button>
        </div>
      </dl>
    </el-dialog> 
  </div>
...
<style lang="scss">
.legao-dialog .details-dialog .el-dialog {
  width: 10.36rem;
}
</style>
