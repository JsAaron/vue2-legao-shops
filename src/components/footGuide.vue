  ...
  <section class='foot_guide'>
    ...
    <section @click="gotoAddress({path: '/home', query: {geohash}})" class="guide_item">
      <svg class="icon_style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('home') !== -1? '#msiteActive' : '#home'"></use>
      </svg>
      <span>外卖</span>
    </section>
...
.guide_item {
  ...
  align-items: center;
  .icon_style {
    @include setWH(.8rem, .8rem);
    margin-top: .3rem;
    fill: #ccc;
  }
  span {
    @include setSC(.45rem, #666);
  }
}
